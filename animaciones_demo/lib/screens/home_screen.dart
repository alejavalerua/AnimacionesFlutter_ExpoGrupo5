            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildDemoCard(context, 'Explicit', Icons.control_camera, Colors.red, const ExplicitAnimationScreen()),
                  _buildDemoCard(context, 'Lottie', Icons.movie_creation, Colors.green, const LottieScreen()),
                  _buildDemoCard(context, 'flutter_animate', Icons.auto_awesome, Colors.pink, const FlutterAnimateScreen()),
                ],
              ),
            ),
          ],
